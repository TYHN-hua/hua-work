...
<!-- 当成普通标签来使用 -->
  ...
  <div style='overflow: hidden'>
    <div style='float:left;'>
     ...
     :title="item.proname" :info="item.info" :price="item.proprice" :index="index"
     @subprice="fn">
     </MyProduct>
    </div>
    <div style='float:left;'>
      <ListLi :arr="list"></ListLi>
    </div>
...
<script>
// 引入
import MyProduct from "./components/myProduct_btn"

import ListLi from "./components/list"
export default {
  data() {
    return {
      msg: "超级好吃的口水鸡",
